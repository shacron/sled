...
int list_find_and_remove(sl_list_t *list, sl_list_node_t *n);

void sl_list_insert_sorted(sl_list_t *list, int(*compare)(const sl_list_node_t *, const sl_list_node_t *), sl_list_node_t *n);

void list_interator_begin(sl_list_iterator_t *iter, sl_list_t *list);
sl_list_node_t * list_interator_next(sl_list_iterator_t *iter);
sl_list_node_t * list_iterator_get_current(sl_list_iterator_t *iter);
void list_iterator_remove_current(sl_list_iterator_t *iter);
